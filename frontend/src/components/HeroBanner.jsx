        ...
        <div className="relative z-10 p-5 md:p-10 flex items-start justify-between">
          ...
          <div className="bg-white/95 backdrop-blur-md p-3.5 md:p-5 rounded-2xl shadow-2xl border border-white/40 max-w-[180px] md:max-w-[220px]">
            <div className="text-center space-y-1">
              <span className="block text-[10px] md:text-xs font-black text-[#00b386] tracking-wider uppercase">
                ⭐ SPECIAL EVENT ⭐
              </span>
              <div className="text-xl md:text-3xl font-black tracking-tight text-[#0047fb] leading-none uppercase drop-shadow-sm">
                BIG BRANDS
              </div>
              <div className="text-2xl md:text-4xl font-black tracking-tighter text-[#0038c7] leading-none uppercase drop-shadow-sm">
                BASH
              </div>
              <div className="pt-1">
                <span className="inline-flex items-center gap-1.5 bg-[#00b386] text-white text-[10px] md:text-xs font-black px-3 py-1 rounded-full uppercase tracking-wider shadow-md">
          ...
          <div className="text-right max-w-xs md:max-w-md space-y-1">
            <div className="text-4xl md:text-8xl font-black text-white tracking-tight drop-shadow-[0_3px_10px_rgba(0,0,0,0.8)] leading-none">
              50-80<span className="text-2xl md:text-5xl align-super font-black">%</span>
            </div>
            <div className="text-sm md:text-xl font-black text-sky-200 uppercase tracking-widest drop-shadow-md">
              OFF
            </div>
